		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        <img src="img/slider-images/Screenshot_9.jpg" alt="">
				        <!-- <p class="caption">This is another caption</p> -->
				      </li>
				      <li>
				        <img src="img/slider-images/Screenshot_8.jpg" alt="">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">ABOUT</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">GALLERY</a></div>
				</div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-mail ui-alt-icon ui-btn-icon-right buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>">CONTACT</a></div>
				</div>				   
		  </div>

            <h2>URBAN CREATIONS, UNIQUE STYLES</h2>
            ...
            <div id="social" class="ui-grid-d">
                ...
                <div class="ui-block-b">
                    <a href="http://www.google.com"><img src="img/web-design/neo-soc_google_w.png" alt=""/></a>
                </div>
                <div class="ui-block-c">
                    <a href="http://www.pinterest.com"><img src="img/web-design/neo-soc_pinterest_w.png" alt=""/></a>
                </div>
                <div class="ui-block-d">
                    <a href="http://www.twitter.com"><img src="img/web-design/neo-soc_twitter_w.png" alt=""/></a>
                </div>
            </div>
            <p>239-403-3773 | 600 Goodlette Rd N. #114, naples, FL 34105</p>
